        ...
        {!showReferralCode && !showPassword ? (
          ...
          <div className="flex flex-col items-center justify-center relative p-5">
            ...
            <div className="min-w-min min-h-min border border-black rounded-xl p-2">
              <div className="flex flex-col items-start mt-5">
                {!isChecked && (
                  // Input Referral Code hanya muncul jika checkbox belum dicentang
                  <div className="relative flex items-center border border-black rounded-lg px-4 py-2.5 focus-within:border-b-4 focus-within:border-r-4 mt-2">
                    <input
                      type="text"
                      className="w-[20rem] pr-12 border-none focus:outline-none text-sm"
                ...
                {/* Checkbox untuk menyembunyikan referral code */}
                <div className="flex items-center space-x-2 mt-3">
                  ...
                  />
                  <label htmlFor="skipReferralCheckbox" className="text-sm font-medium text-gray-900">
                    I don't have a referral code
                  </label>
                </div>

                <button onClick={() => setShowReferralCode(false)} className="mt-3 text-sm text-blue-500 underline">
                  Back
                </button>
                <button onClick={() => setShowPassword(true)} className="mt-3 text-sm text-blue-500 underline">
                  Next
                </button>
              </div>
            </div>
