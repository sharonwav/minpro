    ...
    <main className="w-full h-screen">
      <section className="m-auto w-full max-w-screen-xl h-screen flex flex-col items-center justify-center gap-5">
        <div className="min-w-min min-h-min flex items-center justify-center gap-5 border border-black rounded-xl p-2">
          <Link href="/sign-up/user" className="px-4 py-2.5 border border-black rounded-lg text-sm hover:border-b-4 hover:border-r-4">
            create a user account
          </Link>
          <p className="text-sm">or</p>
          <Link href="/sign-up/creator" className="px-4 py-2.5 border border-black rounded-lg text-sm hover:border-b-4 hover:border-r-4">
            be a creator
          </Link>
        </div>
