...
const FreeTicket: React.FC<Pick<IEvent, 'ticketName' | 'qty' | 'ticketDescription' | 'ticketStartDate' | 'ticketEndDate' | 'ticketStartTime' | 'ticketEndTime'>> = 
({ ticketName, qty, ticketDescription, ticketStartDate, ticketEndDate, ticketStartTime, ticketEndTime }) => {
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center">
          <p className="text-sm font-bold">FREE TICKET</p>
