  ...
  return (
    <main className='m-auto w-full min-h-min max-w-screen-2xl flex mt-[10rem] mb-[10rem] border border-black rounded-lg'>   
      <div className='w-2/4 h-[40rem] border-r border-black relative'>
        <div className='border border-black rounded-xl min-w-min absolute top-2 left-2 flex items-center justify-between gap-5 py-2 px-3'>
      ...
      <div className='w-2/4 h-full grid grod-rows-2'>
       <div className='h-[350px] border-b border-black'>
        <div className='border border-black rounded-xl min-w-min absolute flex items-center justify-between gap-5 mt-2 ml-2 py-2 px-3'>
          <div className='border border-black rounded-full w-7 h-7 flex items-center justify-center'>
            2
          </div>
          <p className='text-sm font-bold'>Top event: <span>The Weeknd tour</span></p>
