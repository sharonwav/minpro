...
const Footer: React.FC = () => {
  return (
    <main className="w-full min-h-min">
      <section className="bg-[#ff6392] w-full border-b border-t border-black">
      ...
      <section className="bg-[#5aa9e6] w-full">
        <div className="m-auto w-full max-w-screen-xl h-20 flex items-center justify-center">
          <div className="min-w-min min-h-min px-2 py-1">
            <p className="text-xs text-white">© 2024 onClick(event)</p>
          </div>
        </div>
      </section>
    </main>
